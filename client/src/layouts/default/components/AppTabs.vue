<template>
  <div class="flex-shrink-0 w-full bg-slate-100 dark:bg-[#14161A] border-b border-gray-200 dark:border-[#14161A] pt-2 px-2 flex items-end space-x-1 overflow-x-auto z-10 transition-colors duration-300 h-[42px]">
    <div
